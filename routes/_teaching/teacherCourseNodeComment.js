exports.teacherCourseNodeComment = function(req,res) {
    ...
    async.waterfall([
        ...
        function(cb){
            ...
            db.field(fields).where({"tcnc_tcnid":restful.tcnc_tcnid,tcnc_is_delete:0}).limit(restful.skip,restful.limit).select("v_teacher_cource_node_comment_user",function(result){
